...
**In short, through reentrancy attack, it is possible to change `xDomainMessageSender` address. So, if any contract relies on this variable as L2 message sender address, it can be impacted.**
